...
foreach ($this->items['items'] as $i => $item) :
    ...
    <tr class="row0">
        ...
        <td style="border-left: none;"><?php echo $item['status_3']['dynamic'];?></td>
        <td><?php echo $item['status_4']['today'];?></td>
        <td style="border-left: none;"><?php echo $item['status_4']['dynamic'];?></td>
        <td><?php echo $item['status_1']['today'];?></td>
        <td style="border-left: none;"><?php echo $item['status_1']['dynamic'];?></td>
        <td><?php echo $item['status_9']['today'];?></td>
        <td style="border-left: none;"><?php echo $item['status_9']['dynamic'];?></td>
